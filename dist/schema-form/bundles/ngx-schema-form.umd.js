(function (global, factory) {
    ...
    (global = global || self, factory(global['ngx-schema-form'] = {}, global.ng.core, global.ng.forms, global.rxjs, global.rxjs.operators, global.ZSchema, global.jexl, global.ng.common));
    ...
    ***************************************************************************** */
                                    ...
                                    var _loop_3 = function (property) {
                                        if (property) {
                                            ...
                                            if (this_1.schema.visibleIf.oneOf) {
                                                valueCheck = property.valueChanges.pipe(operators.map(function (value) { return _this.__evaluateVisibilityIf(_this, property, dependencyPath, value, visibleIf[dependencyPath]); }));
                                            }
    ...
    var WidgetFactory = /** @class */ (function () {
        ...
        WidgetFactory = __decorate([
            core.Injectable(),
            __metadata("design:paramtypes", [WidgetRegistry, core.ComponentFactoryResolver])
        ], WidgetFactory);
    ...
    var FormElementComponentAction = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('target', { read: core.ViewContainerRef, static: true }),
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return ButtonComponent_1; }),
                    }
                ]
            }),
    ...
    var FieldComponent = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ContentChildren(FieldComponent_1),
            __metadata("design:type", core.QueryList)
        ], FieldComponent.prototype, "childFields", void 0);
        __decorate([
            core.ContentChildren(ItemComponent),
            __metadata("design:type", core.QueryList)
        ], FieldComponent.prototype, "childItems", void 0);
        __decorate([
            core.ContentChildren(ButtonComponent),
            __metadata("design:type", core.QueryList)
    ...
    var TemplateSchemaDirective = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ContentChildren(FieldComponent),
            __metadata("design:type", core.QueryList)
